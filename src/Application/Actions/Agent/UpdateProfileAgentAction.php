...
/**
 * @OA\Put(
 *     path="/agent/modification",
 *     tags={"Agent"},
 *     summary="Mise à jour du profil de l'agent",
 *     description="Permet à un agent de mettre à jour son profil",
 *     security={{ "bearerAuth": {} }},
 *     @OA\RequestBody(
 *         required=true,
 *         description="Données pour la mise à jour du profil de l'agent",
 *         @OA\JsonContent(
 *             required={},
 ...
 *             @OA\Property(property="mdp", type="string", example="nouveauMotDePasseAgent")
 *         )
 *     ),
 *     @OA\Response(
 *         response=200,
...
class UpdateProfileAgentAction {
    private $pdo;
    ...
    public function __invoke(Request $request, Response $response): Response {
        ...
        if (count($updates) > 0) {
            $sql = "UPDATE agents SET " . join(', ', $updates) . " WHERE id_agent = ?";
